...
9. Extract the artifact to obtain `RoadsAndTransport-0.1.6.3-alpha.jar`.
...
2. Confirm that `KingdomsAndCurrency-0.1.5-alpha.jar` is installed and working.
3. Place `RoadsAndTransport-0.1.6.3-alpha.jar` in the server's `plugins` folder.
